...
In_File = "color_noise.jpg "
Out_File_OpenCV = "denoise_OpenCV.jpg"
Out_File_PyCuda = "denoise_PyCuda.jpg"
...
print("Denoise filter using OpenCV - Success")
print ("Time taken by CPU (without CUDA) : ",tps_CPU)
print("")
...
print("Denoise filter using CUDA - Success")
print ("Time taken using GPU (with CUDA) : ",tps_GPU)
print("")

cv2.imwrite(Out_File_PyCuda, cv2.cvtColor(image_brut_GPU, cv2.COLOR_BGR2RGB), [int(cv2.IMWRITE_JPEG_QUALITY), 95]) 
